...
export default function Index() {
  return (
    <div className="min-h-screen bg-background">
      {/* Navigation */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-black/95 backdrop-blur-sm border-b border-[#8B6F47]/20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center space-x-3">
              <img src="https://cdn.hercules.app/file_aQTcGHYeGvPzqQbqBg8lU0Ae" alt="HOZA Tanzania Safaris" className="h-16 w-auto" />
              <div>
            ...
            <Card className="border-[#D4915D] hover:shadow-xl transition-shadow">
              <CardContent className="p-8 text-center">
                ...
                <div className="bg-[#FDF6E9] rounded-lg p-4">
                  ...
                  <p className="text-lg font-bold text-[#D4915D]">0715999344</p>
                </div>
              </CardContent>
            </Card>
